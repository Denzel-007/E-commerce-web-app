<template>
  <div id="home">
    ...
    <div id="background-div" class="page-holder bg-cover">
      ...
      <div class="container py-5">
        <header class="text-left text-white py-5">
          ...
          <p id="content" class="lead mb-0 bg-dark p-1 rounded"> My name is Akinlalure Daniel, this is my ALX-SE programme foundationn project for cohort 11</p>
        </header>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-left">
          <h2 class="pt-3">Laptops & Smart Phones</h2>
        </div>
      </div>
      <div class="row">
        <div v-for="index in this.product_size" :key="index" class="col-md-6 col-xl-4 col-12 pt-3  justify-content-around d-flex">
